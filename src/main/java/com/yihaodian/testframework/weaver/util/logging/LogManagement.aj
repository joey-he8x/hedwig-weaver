 ...
 *******************************************************************/
package com.yihaodian.testframework.weaver.util.logging;

import org.apache.log4j.Logger;

public aspect LogManagement pertypewithin(LogOwner+) {
    declare parents: com.yihaodian.testframework.weaver..* && !com.yihaodian.testframework.weaver.util.logging..*+ && !com.yihaodian.testframework.weaver.inspector.error.* implements LogOwner;
